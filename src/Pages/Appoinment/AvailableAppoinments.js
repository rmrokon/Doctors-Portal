...
const AvailableAppoinments = ({ selected }) => {
    ...
    const { data: services, isLoading, error, refetch } = useQuery(['available', formattedDate], () => fetch(`https://doctors-portal-server-rmr.herokuapp.com/available?date=${formattedDate}`)
        .then(res => res.json()))
