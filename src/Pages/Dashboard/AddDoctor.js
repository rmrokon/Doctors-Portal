...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('/services', () => fetch("https://doctors-portal-rmr.herokuapp.com/services").then(res => res.json()));
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch("https://doctors-portal-rmr.herokuapp.com/addDoctor", {
                        method: 'POST',
                        headers: {
